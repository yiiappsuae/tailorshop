...
<div class="col-md-12 no-print pos-header">
  ...
  <div class="row {{$theme_pos_class}}" > <!-- #JCN Color to the header --> 
    ...
    <div class="col-md-6">
      ...
      {{-- #JCN remover popover to fix remove => data-trigger="click" add data-container="body" --}}
      <button type="button" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right" data-toggle="popover" 
        id="return_sale" title="@lang('lang_v1.sell_return')"  
