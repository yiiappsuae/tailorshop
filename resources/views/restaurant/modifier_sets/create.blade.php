                ...
                <th>
                  ...
                  @php
                    $html = '<tr><td>
                        ...
                        <td>
                            <div class="form-group">
                           <input type="text" name="modifier_type[]" class="form-control input_number" 
                            placeholder="type" required>
                          </div>
                        </td> <td>
                            <div class="form-group">
                           <input type="text" name="modifier_default_value_edit[]" class="form-control input_number" 
