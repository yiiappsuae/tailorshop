                ...
                <th>
                  ...
                  @php
                    $html = '<tr><td>
                        ...
                        <td>
                            <div class="form-group">
                           <input type="text" name="modifier_type[]" class="form-control" 
                            placeholder="type" required>
                          </div>
                        </td>
                         <td>
                            <div class="form-group">
                           <input type="text" name="modifier_default_value[]" class="form-control input_number" 
            ...
            <tbody>
              @foreach($modifer_set->variations as $modifier)
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="modifier_type_edit[{{$modifier->id}}]" 
                      class="form-control" value="{{$modifier->type}}" placeholder="Type" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                      <input type="text" name="modifier_default_value_edit[{{$modifier->id}}]" 
                      class="form-control" value="{{$modifier->default_value}}" placeholder="default value" required>
                    </div>
                  </td>
                  <td>
                    @if(!$loop->first)
