...
<tr class="product_row" data-row_index="{{$row_count}}" @if(!empty($so_line)) data-so_id="{{$so_line->transaction_id}}" @endif>
	...
	<td class="text-center">
		...
		<input type="hidden" class="single_purchase_price" value="{{$product->default_purchase_price}}">
		
		<input type="hidden" class="pos_line_purchase_total" value="{{$product->default_purchase_price}}">
