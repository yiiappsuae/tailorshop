...
[Get Postman Collection](https://alzaier.yiiapps.com/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"aliquam","ip_address":"asperiores","latitude":"dolorem","longitude":"minus"}'
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"quas","latitude":"et","longitude":"aut"}'
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/holidays?location_id=1&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=dolores&follow_up_type=molestiae&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=cumque&biz_name=doloremque&mobile_num=6&contact_id=dolorem&order_by=reiciendis&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"sed","mobile_name":"laboriosam","call_type":"call","start_time":"est","end_time":"fugit","duration":"voluptas"}]}'
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=1&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":597.8083,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":1.026,"total_card_slips":13,"total_cheques":3,"closing_note":"facere","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/contactapi?type=incidunt&name=maiores&biz_name=cupiditate&mobile_num=4&contact_id=repellendus&order_by=omnis&direction=dolorem&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"accusantium","prefix":"delectus","first_name":"alias","middle_name":"pariatur","last_name":"suscipit","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"dolore","address_line_2":"iusto","city":"explicabo","state":"molestiae","country":"totam","zip_code":"corrupti","customer_group_id":"modi","contact_id":"et","dob":"2000-06-13","custom_field1":"ipsam","custom_field2":"cum","custom_field3":"repellendus","custom_field4":"unde","email":"officia","shipping_address":"sed","position":"nihil","opening_balance":0,"source_id":13,"life_stage_id":16,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "accusantium",
    "prefix": "delectus",
    "first_name": "alias",
    ...
    "address_line_2": "iusto",
    "city": "explicabo",
    "state": "molestiae",
    "country": "totam",
    "zip_code": "corrupti",
    "customer_group_id": "modi",
    "contact_id": "et",
    "dob": "2000-06-13",
    "custom_field1": "ipsam",
    "custom_field2": "cum",
    "custom_field3": "repellendus",
    "custom_field4": "unde",
    "email": "officia",
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"aut","prefix":"praesentium","first_name":"eos","middle_name":"laborum","last_name":"ut","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"rerum","address_line_2":"nemo","city":"assumenda","state":"sunt","country":"neque","zip_code":"sequi","customer_group_id":"ad","contact_id":"omnis","dob":"2000-06-13","custom_field1":"impedit","custom_field2":"dolorem","custom_field3":"eligendi","custom_field4":"aliquam","email":"consequatur","shipping_address":"labore","position":"earum","opening_balance":10.3,"source_id":6,"life_stage_id":6,"assigned_to":[]}'
...
let body = {
    ...
    "country": "neque",
    "zip_code": "sequi",
    "customer_group_id": "ad",
    "contact_id": "omnis",
    "dob": "2000-06-13",
    "custom_field1": "impedit",
    "custom_field2": "dolorem",
    "custom_field3": "eligendi",
    "custom_field4": "aliquam",
    "email": "consequatur",
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":9,"card_number":"et","card_holder_name":"tempora","card_transaction_number":"dolore","card_type":"odit","card_month":"autem","card_year":"voluptas","card_security":"deserunt","transaction_no_1":"rerum","transaction_no_2":"delectus","transaction_no_3":"quis","cheque_number":"harum","bank_account_number":"cumque","note":"qui"}'
...
let body = {
    ...
    "account_id": 9,
    "card_number": "et",
    "card_holder_name": "tempora",
    "card_transaction_number": "dolore",
    "card_type": "odit",
    "card_month": "autem",
    "card_year": "voluptas",
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=fugiat&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":2.6946477,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":7,"expense_for":3,"contact_id":8,"expense_category_id":10,"expense_sub_category_id":15,"additional_notes":"vero","is_refund":0,"is_recurring":0,"recur_interval":7,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"sed","recur_repetitions":14,"payment":[{"amount":453.13,"method":"cash","account_id":12,"card_number":"architecto","card_holder_name":"sunt","card_transaction_number":"ab","card_type":"autem","card_month":"exercitationem","card_year":"iure","card_security":"assumenda","transaction_no_1":"ab","transaction_no_2":"fugiat","transaction_no_3":"voluptatibus","note":"et","cheque_number":"dolores"}]}'
    ...
    "payment": [
        {
            ...
            "card_transaction_number": "ab",
            "card_type": "autem",
            "card_month": "exercitationem",
            "card_year": "iure",
            "card_security": "assumenda",
            "transaction_no_1": "ab",
            "transaction_no_2": "fugiat",
            "transaction_no_3": "voluptatibus",
            "note": "et",
            "cheque_number": "dolores"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://alzaier.yiiapps.com/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":31853340.527,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":6,"expense_for":12,"contact_id":14,"expense_category_id":12,"expense_sub_category_id":6,"additional_notes":"nihil","is_recurring":0,"recur_interval":10,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"magnam","recur_repetitions":15,"payment":[]}'
...
let body = {
    ...
    "additional_notes": "nihil",
    "is_recurring": 0,
    "recur_interval": 10,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "magnam",
    "recur_repetitions": 15,
    "payment": []
}
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=iure&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/expense-categories" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/expense-categories"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/field-force?contact_id=voluptas&assigned_to=exercitationem&status=ea&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/field-force"
);

let params = {
    "contact_id": "voluptas",
    "assigned_to": "exercitationem",
    "status": "ea",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "per_page": "15",
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/field-force/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":4,"visit_to":"facere","visit_address":"alias","assigned_to":13,"visit_on":"2021-12-28 17:23:00","visit_for":"autem"}'
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/field-force/update-visit-status/17" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"omnis","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"sit","photo":"qui"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "omnis",
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/product?order_by=nihil&order_direction=pariatur&brand_id=atque&category_id=sunt&sub_category_id=molestiae&location_id=1&selling_price_group=expedita&send_lot_detail=ratione&name=eum&sku=minus&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/product"
);

let params = {
    "order_by": "nihil",
    "order_direction": "pariatur",
    "brand_id": "atque",
    "category_id": "sunt",
    "sub_category_id": "molestiae",
    "location_id": "1",
    "selling_price_group": "expedita",
    "send_lot_detail": "ratione",
    "name": "eum",
    "sku": "minus",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/product/1?selling_price_group=quis&send_lot_detail=facilis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "quis",
    "send_lot_detail": "facilis",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/variation/2?product_id=nisi&location_id=1&brand_id=expedita&category_id=voluptas&sub_category_id=harum&not_for_selling=debitis&name=reiciendis&sku=itaque&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/variation/2"
);
...
let params = {
    ...
    "sub_category_id": "harum",
    "not_for_selling": "debitis",
    "name": "reiciendis",
    "sku": "itaque",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/sell?location_id=1&contact_id=quia&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=error&service_staff_id=modi&shipping_status=ordered&source=et&only_subscriptions=doloremque&send_purchase_details=occaecati&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "error",
    "service_staff_id": "modi",
    "shipping_status": "ordered",
    "source": "et",
    "only_subscriptions": "doloremque",
    "send_purchase_details": "occaecati",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":15,"transaction_date":"2020-07-22 15:48:29","invoice_no":"dolor","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":7,"discount_amount":10,"discount_type":"fixed","sale_note":"rerum","staff_note":"natus","commission_agent":20,"shipping_details":"Express Delivery","shipping_address":"voluptatem","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":3,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":12,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"quibusdam","recur_repetitions":8,"rp_redeemed":14,"rp_redeemed_amount":13.5,"types_of_service_id":3,"service_custom_field_1":"vitae","service_custom_field_2":"exercitationem","service_custom_field_3":"aliquam","service_custom_field_4":"doloremque","service_custom_field_5":"quisquam","service_custom_field_6":"et","round_off_amount":62598258,"table_id":18,"service_staff_id":17,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":7,"note":"neque"}],"payments":[{"amount":453.13,"method":"cash","account_id":13,"card_number":"quisquam","card_holder_name":"nulla","card_transaction_number":"eum","card_type":"voluptas","card_month":"molestiae","card_year":"itaque","card_security":"optio","transaction_no_1":"atque","transaction_no_2":"sapiente","transaction_no_3":"voluptas","bank_account_number":"libero","note":"earum","cheque_number":"molestiae"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "quibusdam",
            "recur_repetitions": 8,
            "rp_redeemed": 14,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 3,
            "service_custom_field_1": "vitae",
            "service_custom_field_2": "exercitationem",
            "service_custom_field_3": "aliquam",
            "service_custom_field_4": "doloremque",
            "service_custom_field_5": "quisquam",
            "service_custom_field_6": "et",
            "round_off_amount": 62598258,
            "table_id": 18,
            "service_staff_id": 17,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_type": "voluptas",
                    "card_month": "molestiae",
                    "card_year": "itaque",
                    "card_security": "optio",
                    "transaction_no_1": "atque",
                    "transaction_no_2": "sapiente",
                    "transaction_no_3": "voluptas",
                    "bank_account_number": "libero",
                    "note": "earum",
                    "cheque_number": "molestiae"
                }
            ]
        }
    ]
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/sell/55?send_purchase_details=atque" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/sell/55"
);

let params = {
    "send_purchase_details": "atque",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X PUT \
    "https://alzaier.yiiapps.com/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":6,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":12,"discount_amount":10,"discount_type":"fixed","sale_note":"ut","source":"exercitationem","staff_note":"eveniet","is_suspend":false,"commission_agent":14,"shipping_details":"Express Delivery","shipping_address":"eveniet","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":19,"pay_term_number":16,"pay_term_type":"months","is_recurring":0,"recur_interval":19,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"accusamus","recur_repetitions":8,"rp_redeemed":10,"rp_redeemed_amount":13.5,"types_of_service_id":10,"service_custom_field_1":"natus","service_custom_field_2":"nihil","service_custom_field_3":"aspernatur","service_custom_field_4":"quidem","service_custom_field_5":"est","service_custom_field_6":"provident","round_off_amount":229729564.2645,"table_id":13,"service_staff_id":12,"change_return":0,"change_return_id":13,"products":[{"sell_line_id":9,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":15,"discount_amount":0,"discount_type":"percentage","sub_unit_id":10,"note":"fugit"}],"payments":[{"payment_id":18,"amount":453.13,"method":"cash","account_id":7,"card_number":"vero","card_holder_name":"ea","card_transaction_number":"dolorum","card_type":"voluptatem","card_month":"voluptatem","card_year":"ea","card_security":"atque","transaction_no_1":"ut","transaction_no_2":"similique","transaction_no_3":"vel","note":"quo","cheque_number":"aut","bank_account_number":"sunt"}]}'
...
let body = {
    ...
    "rp_redeemed": 10,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 10,
    "service_custom_field_1": "natus",
    "service_custom_field_2": "nihil",
    "service_custom_field_3": "aspernatur",
    "service_custom_field_4": "quidem",
    "service_custom_field_5": "est",
    "service_custom_field_6": "provident",
    "round_off_amount": 229729564.2645,
    "table_id": 13,
    "service_staff_id": 12,
    "change_return": 0,
    "change_return_id": 13,
    ...
    "payments": [
        {
            ...
            "card_security": "atque",
            "transaction_no_1": "ut",
            "transaction_no_2": "similique",
            "transaction_no_3": "vel",
            "note": "quo",
            "cheque_number": "aut",
            "bank_account_number": "sunt"
        }
    ]
}
...
```bash
curl -X DELETE \
    "https://alzaier.yiiapps.com/public/connector/api/sell/vero" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":20,"transaction_date":"2020-5-7 15:20:22","invoice_no":"ducimus","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":20,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":20,"shipping_status":"ordered","delivered_to":"voluptates"}'
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/table?location_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/taxonomy?type=occaecati" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"excepturi","first_name":"laboriosam","last_name":"ipsam","email":"assumenda","is_active":"animi","user_type":"est","crm_contact_id":9,"allow_login":false,"username":"provident","password":"nam","role":17,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"consectetur","max_sales_discount_percent":"repellendus","selected_contacts":true,"selected_contact_ids":[],"dob":"neque","gender":"quae","marital_status":"perspiciatis","blood_group":"et","contact_number":"aliquid","alt_number":"velit","family_number":"nulla","fb_link":"quia","twitter_link":"quia","social_media_1":"hic","social_media_2":"odio","custom_field_1":"eos","custom_field_2":"minus","custom_field_3":"non","custom_field_4":"beatae","guardian_name":"est","id_proof_name":"consequatur","id_proof_number":"animi","permanent_address":"numquam","current_address":"culpa","bank_details":[{"account_holder_name":"sint","account_number":"rerum","bank_name":"quia","bank_code":"doloribus","branch":"non","tax_payer_id":"occaecati"}]}'
...
let body = {
    ...
    "cmmsn_percent": "consectetur",
    "max_sales_discount_percent": "repellendus",
    ...
    "social_media_2": "odio",
    "custom_field_1": "eos",
    "custom_field_2": "minus",
    "custom_field_3": "non",
    "custom_field_4": "beatae",
    "guardian_name": "est",
    "id_proof_name": "consequatur",
    "id_proof_number": "animi",
    "permanent_address": "numquam",
    "current_address": "culpa",
    "bank_details": [
        {
            "account_holder_name": "sint",
            "account_number": "rerum",
            "bank_name": "quia",
            "bank_code": "doloribus",
            "branch": "non",
            "tax_payer_id": "occaecati"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/user?service_staff=non" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"officiis","new_password":"autem"}'
...
```bash
curl -X POST \
    "https://alzaier.yiiapps.com/public/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"aut"}'
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/profit-loss-report?location_id=1&start_date=2018-06-25&end_date=2018-06-25&user_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/notifications"
);
...
```bash
curl -X GET \
    -G "https://alzaier.yiiapps.com/public/connector/api/get-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
```javascript
const url = new URL(
    "https://alzaier.yiiapps.com/public/connector/api/get-location"
);
