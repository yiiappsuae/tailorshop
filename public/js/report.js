$(document).ready(function() {
    ...
    sell_payment_report = $('table#sell_payment_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'paid_on', name: 'paid_on' },
            { data: 'amount', name: 'transaction_payments.amount' },
            { data: 'actual_amount', name: 'transaction_payments.actual_amount' },
            { data: 'customer', orderable: false, searchable: false },
        ...
        fnDrawCallback: function(oSettings) {
            ...
            $('#footer_total_amount').text(total_amount);
             var total_amount_actual_amount = sum_table_col($('#sell_payment_report_table'), 'paid-actual_amount');
            $('#footer_total_actual_amount').text(total_amount_actual_amount);
