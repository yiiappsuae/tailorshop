                            ...
                            if (!empty($product['modifier_sell_line_id'][$key])) {
                              ...
                              //  if (!empty($product['modifier_price'][$key])) {
                                    ...
                                    $modifiers_formatted[] = new TransactionSellLine([
                                        ...
                                        'measure' => $product['modifiers_measure'][$key],
                                        'metrial_need' => $product['metrial_need'],
                                        'metrial_id' => $product['metrial_id'],
                                        'farah_id' => $product['farah_id'],
                                        'unit_price_before_discount' => $this_price,
                                        'unit_price' => $product['modifier_value'][$key],
