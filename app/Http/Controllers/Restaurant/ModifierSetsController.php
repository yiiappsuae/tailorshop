    ...
    public function update($id, Request $request)
    {
        ...
        try {
            ...
            if (!empty($input['modifier_name_edit'])) {
                ...
                $modifier_type_edit  = $input['modifier_type_edit'];
                $modifier_default_value_edit  = $input['modifier_default_value_edit'];
                ...
                foreach ($modifier_name_edit as $key => $name) {
                    if (isset($modifier_price_edit[$key])) {
                        ...
                        $variations_edit[$key]['type'] = $modifier_type_edit[$key];
                        $variations_edit[$key]['default_value'] = $modifier_default_value_edit[$key];
            ...
            if (!empty($input['modifier_name'])) {
                foreach ($input['modifier_name'] as $key => $value) {
                    $variations[] = [
                        ...
                        'default_sell_price' => $input['modifier_price'][$key],
                        'sell_price_inc_tax' => $input['modifier_price'][$key],
                        'type' => $input['modifier_type'][$key],
                        'default_value' => $input['modifier_default_value'][$key],
                    ];
                }
            }
